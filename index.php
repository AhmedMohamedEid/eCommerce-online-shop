    ...
    <div class="container">
        ...
        foreach($cats as $cat){
            ...
            echo '<div class="col-md-3 col-xs-6">
                <div class="shop" style="max-height:175px">
                    <div class="shop-img">
                        <img src="'.$imgItem . $cat["Images"].'" alt="'.$cat["Name"].'">
                    </div>
                    <div class="shop-body">
                ...
                <div class="row">
                    <div class="products-tabs">
                        ...
                        <div id="tab1" class="tab-pane active">
                            ...
                            <?php
                                $products = getAllFrom('*' , 'items' , '' , '' ,'Cat_ID' );
                                foreach($products as $product){ ?>
                                    <!-- product -->
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="<?=$imgItem . $product['Image']?>" alt="<?=$product['Name'] ?>">
                    ...
                    <div class="products-tabs">
                        ...
                        <div id="tab2" class="tab-pane fade in active">
                            ...
                            foreach($products as $product){ ?>
                                ...
                                <div class="product">
                                    <div class="product-img">
                                        <img src="<?=$imgItem . $product['Image']?>" alt="">
                                        <div class="product-label">
                                            <span class="sale">-30%</span>
                                            <span class="new">NEW</span>
                                        </div>
                ...
                echo "<div class='col-md-3 col-sm-6'>";
                    echo "<div class='thumbnail item-box'>";
                        ...
                        echo "<div class='caption'>";
                            echo "<h3><a href='<?php echo $page; ?>item.php?itemid=". $item['Item_ID']."'>". ucfirst($item['Name']) ."</a></h3>";
